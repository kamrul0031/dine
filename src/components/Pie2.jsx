...
function Pie2() {
  ...
  useEffect(() => {
    const chartInstance = new ApexCharts(chartRef.current, pie2Options);
  ...
  const handleCheckboxChange = (event) => {
    if (chart) {
      ...
      switch (checkbox.value) {
        case 'desktop':
          newSeries = checkbox.checked ? [15.1, 22.5, 4.4, 8.4] : [35.1, 23.5, 2.4, 5.4];
          break;
        case 'tablet':
          newSeries = checkbox.checked ? [25.1, 26.5, 1.4, 3.4] : [35.1, 23.5, 2.4, 5.4];
          break;
        case 'mobile':
          newSeries = checkbox.checked ? [45.1, 27.5, 8.4, 2.4] : [35.1, 23.5, 2.4, 5.4];
          break;
        default:
          newSeries = checkbox.checked ? [55.1, 28.5, 1.4, 5.4] : [35.1, 23.5, 2.4, 5.4];
      }
  ...
  return (
    <div>
      <div className="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        ...
        {/* Donut Chart */}
        <div className="py-6" id="donut-chart" ref={chartRef} />
